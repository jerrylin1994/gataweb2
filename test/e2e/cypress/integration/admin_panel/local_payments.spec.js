describe( "Admin Panel - LocalPayments", () => {
  ...
  it( "Should be able to enable LocalPayments", function() {
    cy.contains( "a", "LocalVisits" )
      .click()
    cy.contains( "Status" )
      .children( "select" )
      .select( "Live" )
    cy.get( `div[heading="Payments"]` )
      .contains( "Enabled" )
      .click()
    ...
    cy.contains( "LocalVisits" )
      .click()
    // assertion: should see send payment button LocalVisits page
    cy.contains( "button", "Send Payment Link" )
      .should( "be.visible" )
  } )
} )
